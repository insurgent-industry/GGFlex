...
The Ghost Gunner FLEX community is pursuing multiple development goals. Leveraging the project's modular design, different portions of our community are actively developing cheaper framing and build options using SAE hardware, full RepRap compliance (using the machine to manufacture the parts required to build more of itself), a 4th rotary axis for more complex parts manufacture, and a dedicated electronics and software suite... with much more to come! Beginning with the public project launch on Friday, October 9th 2020, we actively invite all interested parties to join us and help stretch the project's capabilities as we continue to grow!</b></i><br><br><br><br>
<b>QUICK LINKS</b><br><br>
[Specifications](https://github.com/insurgent-industry/GGFlex/wiki/Specifications) - The particular hardware related specifications and parameters of the project <br>
[Frequently Asked Questions](https://github.com/insurgent-industry/GGFlex/wiki/Frequently-Asked-Questions) - Answers to common questions <br>
[The Bill of Materials](https://github.com/insurgent-industry/GGFlex/wiki/Bill-of-Materials) - The current version's bill of materials in plain text <br>
[Assembly TXT](https://github.com/insurgent-industry/GGFlex/wiki/Assembly-Guide) - The current version's build instructions and parts list in plain text <br>
[Assembly PDF](/Media/PDF) - The current version's build instructions in PDF format <br>
