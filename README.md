...
2. The FLEX includes endstops for automatic, repeatable, and absolute zeroing of axes [UNDER DEVELOPMENT]
3. The FLEX includes alternate mounts for controllers (RAMPS, MKS GEN/DLC, Smoothie, etc.) in addition to the standard CNC Shield [UNDER DEVELOPMENT]
4. The FLEX includes alternate mounts for spindles (Ryobi, Dewalt, Bosch, etc. router spindles) in addition to the HF 2.4A trim and 52mm hobby DC [UNDER DEVELOPMENT]
5. The FLEX includes pallet-type work changing allowing the rapid swap of different tooling jigs for different projects
